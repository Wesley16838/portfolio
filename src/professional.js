...
import hsuanfu from './Assets/img/hsuanfu2x.png'
...
class Professional extends Component {
  ...
  infrastructure and application analytics"/>
            <ProfessionalPart title="HsuanFu Wood" company="Creatop" position="Front-End Developer Intern" location="Taichung, Taiwan" date="June 2019 - July 2018" image={hsuanfu} url="http://www.hsuanfu.com.tw/en/" first="Customized a responsive web design using SCSS and Bootstrap for Furniture 
