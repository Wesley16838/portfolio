...
class Professional extends Component {
  ...
  infrastructure and application analytics"
    ...
    features using Flutter and Dart"
          ...
          <ProfessionalPart
            title="CannaSphere"
            company="CannaSphere.org and The Cannabis Fair Trade 
          Organization"
            position="Jr. Front-End Dev, UI/UX Redesign Team Intern"
            location="Seattle, WA"
            date="Feb 2018 - Apr 2018"
            image={cannasphere}
            url="http://cannasphere.org/"
            first="Redesigned the web page layout using Adobe XD and implemented Responsive
              Web Design using Bootstrap"
            second="Held daily scrum meeting with the redesign team to achieve agile development"
          />
